...
SECRET_KEY = 'django-insecure-=8el4y_k42$_ljyh_8yz2h)0=k^^jal7bcc@q1d&lyw3*ix%6k'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['51.21.153.84', 'localhost', '127.0.0.1']
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Team Tracker Admin",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Team Tracker",
    ...
    "welcome_sign": "Welcome to Team Tracker Admin Portal",
    ...
    "search_model": ["members.Member", "members.Task"],
    ...
    "topmenu_links": [
        ...
        {"name": "Support", "url": "https://frankmathewsajan.web.app/", "new_window": True},
    ...
    "order_with_respect_to": ["auth", "members"],
